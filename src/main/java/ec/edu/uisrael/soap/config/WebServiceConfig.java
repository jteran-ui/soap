package ec.edu.uisrael.soap.config;
...
public class WebServiceConfig {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema saludoSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://ejemplo.com/saludos");
    ...
    public XsdSchema saludoSchema() {
        return new SimpleXsdSchema(new ClassPathResource("saludo.xsd"));
    }
